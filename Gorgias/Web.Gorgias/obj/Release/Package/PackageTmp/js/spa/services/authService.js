...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
    ...
    var _login = function (loginData) {
        ...
        $http.post(serviceBase + 'token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
            ...
            if (loginData.useRefreshTokens) {
                localStorageService.set('authorizationData', { userID: _authentication.userID, userFullName: _authentication.userFullName, userIsConfirmed: _authentication.userIsConfirmed, userIsPeople: _authentication.userIsPeople, userProfileURL: _authentication.userProfileURL, userProfileTypeID: _authentication.userProfileTypeID, token: response.access_token, userName: loginData.userName, refreshToken: response.refresh_token, useRefreshTokens: true });
                _authentication.useRefreshTokens = true;
            }
            else {
                localStorageService.set('authorizationData', { userID: _authentication.userID, userFullName: _authentication.userFullName, userIsConfirmed: _authentication.userIsConfirmed, userIsPeople: _authentication.userIsPeople, userProfileURL: _authentication.userProfileURL, userProfileTypeID: _authentication.userProfileTypeID, token: response.access_token, userName: loginData.userName, refreshToken: "", useRefreshTokens: false });
