(function (app) {
    'use strict';
    app.controller('listprofileProfileController', ['$scope', '$route', '$http', '$compile', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, $compile, apiService, ngAuthSettings, $location, notificationService) {
