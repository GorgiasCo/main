        ...
        $http.post(serviceBase + 'token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
            ...
            if (response.UserRole == 1) {
                ...
                if (loginData.useRefreshTokens) {
                    ...
                    localStorageService.set('authorizationData', { userID: _authentication.userID, token: response.access_token, userName: loginData.userName, userFullName: _authentication.userFullName, refreshToken: "", useRefreshTokens: false, userRole: response.UserRole });
                    _authentication.useRefreshTokens = false;
                }
            }
