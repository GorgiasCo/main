(function (app) {
    'use strict';
    app.controller('listprofileAddressController', ['$scope', '$route', '$http', '$compile', 'apiService', 'ngAuthSettings', '$location', 'notificationService', 'NgMap', '$filter', function ($scope, $route, $http, $compile, apiService, ngAuthSettings, $location, notificationService, NgMap, $filter) {
        var vm = this;
