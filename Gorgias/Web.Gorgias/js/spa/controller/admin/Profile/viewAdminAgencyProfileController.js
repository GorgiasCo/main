(function (app) {
    'use strict';
    app.controller('viewAdminAgencyProfileController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', '$anchorScroll', 'authService', '$translate', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService, $anchorScroll, authService, $translate) {
        ...
        function checkValidity() {
            if (authService.authentication.userID == 0 || $scope.ProfileID != authService.authentication.userID) {
        ...
        function loadAgencyProfiles() {
            apiService.get($scope.baseURL + 'api/Web/Administration/Agency/' + authService.authentication.userName, null,
