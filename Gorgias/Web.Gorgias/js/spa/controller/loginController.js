(function (app) {
    'use strict';
    app.controller('loginController', ['$scope', '$route', '$http', 'apiService', 'authService', 'ngAuthSettings', '$location', 'notificationService', 'close', function ($scope, $route, $http, apiService, authService, ngAuthSettings, $location, notificationService, close) {
            ...
            authService.login($scope.loginData).then(function (response) {
                ...
                switch (authService.authentication.userRole) {
                    case "1":
                        ...
                        console.log(authService.authentication.userID, 'WOWL successful login 1');
                        break;
                    case "3":
                        $location.path('/admin/agency/profile/' + authService.authentication.userID);
                        console.log(authService.authentication.userID, 'WOWL successful login 3');
                        break;
                    case "2":
                        $location.path('/admin/agency/profile/' + authService.authentication.userID);
                        console.log(authService.authentication.userID, 'WOWL successful login 2');
                        break;
                    case "0":
                        $location.path('/admin/agency/profile/' + authService.authentication.userID);
                        console.log(authService.authentication.userID, 'WOWL successful login 0');
                        break;                                            
                }
