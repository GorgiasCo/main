(function (app) {
    'use strict';
    app.controller('viewProfileSocialNetworkController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("viewProfileSocialNetworkController loaded ;)");
        ...
        function insertObject() {
            apiService.post($scope.baseURL +'api/ProfileSocialNetwork/ProfileSocialNetworkID/' + $scope.ProfileSocialNetworkID, $scope.object,
