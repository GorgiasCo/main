(function (app) {
    'use strict';
    app.controller('listprofileProfileAttributeController', ['$scope', '$route', '$http', '$compile', 'apiService', 'DTOptionsBuilder', 'DTColumnBuilder', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, $compile, apiService, DTOptionsBuilder, DTColumnBuilder, ngAuthSettings, $location, notificationService) {
        ...
        $scope.attributeUpdate = function (item) {
            ...
            if ($scope.isEdit == false) {
                $scope.object = { ProfileID: $route.current.params.id, AttributeID: item.AttributeID };
