(function (app) {
    'use strict';
    app.controller('viewProfileAttributeController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("viewProfileAttributeController loaded ;)");
        ...
        function insertObject() {
            apiService.post($scope.baseURL +'api/ProfileAttribute/ProfileAttributeID/' + $scope.ProfileAttributeID, $scope.object,
