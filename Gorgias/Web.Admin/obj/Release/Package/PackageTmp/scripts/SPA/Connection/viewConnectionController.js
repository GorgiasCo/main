(function (app) {
    'use strict';
    app.controller('viewConnectionController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("viewConnectionController loaded ;)");
        ...
        function insertObject() {
            apiService.post($scope.baseURL +'api/Connection/ConnectionID/' + $scope.ConnectionID, $scope.object,
