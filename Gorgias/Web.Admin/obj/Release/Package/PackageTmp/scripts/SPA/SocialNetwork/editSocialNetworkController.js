(function (app) {
    'use strict';
    app.controller('editSocialNetworkController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editSocialNetworkController loaded ;)");
        ...
        //$scope.SocialNetworkID = $route.current.params.id;                        
        $scope.hasFile = false;
