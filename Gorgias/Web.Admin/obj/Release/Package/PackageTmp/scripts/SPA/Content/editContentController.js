(function (app) {
    'use strict';
    app.controller('editContentController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editContentController loaded ;)");
        ...
        //$scope.ContentID = $route.current.params.id;                        
        $scope.hasFile = false;
