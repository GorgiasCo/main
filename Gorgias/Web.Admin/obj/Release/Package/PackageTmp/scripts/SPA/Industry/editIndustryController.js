(function (app) {
    'use strict';
    app.controller('editIndustryController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editIndustryController loaded ;)");
        ...
        //$scope.IndustryID = $route.current.params.id;                        
        $scope.hasFile = false;
