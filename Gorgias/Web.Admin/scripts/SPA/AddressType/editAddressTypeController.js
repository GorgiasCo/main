(function (app) {
    'use strict';
    app.controller('editAddressTypeController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editAddressTypeController loaded ;)");
        ...
        //$scope.AddressTypeID = $route.current.params.id;                        
        $scope.hasFile = false;
