(function (app) {
    'use strict';
    app.controller('viewProfileTagController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("viewProfileTagController loaded ;)");
        ...
        function insertObject() {
            apiService.post($scope.baseURL +'api/ProfileTag/ProfileTagID/' + $scope.ProfileTagID, $scope.object,
