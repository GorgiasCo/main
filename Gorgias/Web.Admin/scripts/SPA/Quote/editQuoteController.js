(function (app) {
    'use strict';
    app.controller('editQuoteController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editQuoteController loaded ;)");
        ...
        //$scope.QuoteID = $route.current.params.id;                        
        $scope.hasFile = false;
