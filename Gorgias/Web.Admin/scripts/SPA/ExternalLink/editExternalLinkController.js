(function (app) {
    'use strict';
    app.controller('editExternalLinkController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editExternalLinkController loaded ;)");
        ...
        //$scope.ExternalLinkID = $route.current.params.id;                        
        $scope.hasFile = false;
        ...
        function insertObject() {
            apiService.post($scope.baseURL +'api/ExternalLink/LinkTypeID/ProfileID/' + $scope.LinkTypeID + "/"  + $scope.ProfileID, $scope.object,
