(function (app) {
    'use strict';
    app.controller('editLanguageController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editLanguageController loaded ;)");
        ...
        //$scope.LanguageID = $route.current.params.id;                        
        $scope.hasFile = false;
