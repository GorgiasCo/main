(function (app) {
    'use strict';
    app.controller('editFeatureController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editFeatureController loaded ;)");
        ...
        //$scope.FeatureID = $route.current.params.id;                        
        $scope.hasFile = false;
