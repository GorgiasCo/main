(function (app) {
    'use strict';
    app.controller('editContentTypeController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editContentTypeController loaded ;)");
        ...
        //$scope.ContentTypeID = $route.current.params.id;                        
        $scope.hasFile = false;
