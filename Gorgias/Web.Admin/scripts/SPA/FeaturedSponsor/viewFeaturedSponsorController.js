(function (app) {
    'use strict';
    app.controller('viewFeaturedSponsorController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("viewFeaturedSponsorController loaded ;)");
        ...
        function insertObject() {
            apiService.post($scope.baseURL +'api/FeaturedSponsor/FeaturedSponsorID/' + $scope.FeaturedSponsorID, $scope.object,
