(function (app) {
    'use strict';
    app.controller('editContentRatingController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editContentRatingController loaded ;)");
        ...
        //$scope.ContentRatingID = $route.current.params.id;                        
        $scope.hasFile = false;
