(function (app) {
    'use strict';
    app.controller('editRequestTypeController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editRequestTypeController loaded ;)");
        ...
        //$scope.RequestTypeID = $route.current.params.id;                        
        $scope.hasFile = false;
