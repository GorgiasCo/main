/// <reference path="../plugins/ng-dropzone-2.0.1/src/js/ng-dropzone.js" />
/* ============================================================
    ...
    .config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
        $ocLazyLoadProvider.config({
            ...
            modules: [{
                    ...
                    name: 'dropzone',
                    files: [
                        //'assets/plugins/dropzone-old/css/dropzone.css',
                        'assets/plugins/dropzone/dropzone.js',
                        'assets/plugins/ng-dropzone-2.0.1/src/js/ng-dropzone.js'
                    ],
                    serie: true
                }, {
                    name: 'wizard',
