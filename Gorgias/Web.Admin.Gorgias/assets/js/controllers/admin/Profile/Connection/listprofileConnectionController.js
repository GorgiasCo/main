(function (app) {
    'use strict';
    app.controller('listprofileConnectionController', ['$scope', '$route', '$http', '$compile', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, $compile, apiService, ngAuthSettings, $location, notificationService) {
