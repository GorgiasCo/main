...
angular.module('gorgiasapp')
    .controller('viewAdminProfileController', ['$scope', '$stateParams', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', '$anchorScroll', 'authService', '$translate',
