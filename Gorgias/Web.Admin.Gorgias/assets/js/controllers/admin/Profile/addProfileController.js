(function (app) {
    'use strict';
    app.controller('addProfileController', ['$scope', '$state', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', 'authService',
        function ($scope, $state, $http, apiService, ngAuthSettings, $location, notificationService, authService) {
