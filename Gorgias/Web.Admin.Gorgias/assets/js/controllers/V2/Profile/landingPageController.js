(function (app) {
    'use strict';
    app.controller('landingPageController', ['$scope', '$stateParams', '$http', '$compile', 'apiService', 'ngAuthSettings', '$location', 'notificationService', '$filter', 'uuid', '$state', 'localStorageService',
        function ($scope, $stateParams, $http, $compile, apiService, ngAuthSettings, $location, notificationService, $filter, uuid, $state, localStorageService) {
            ...
            $scope.item = 1011;//$stateParams.id;//$route.current.params.id;
            ...
            //Load Profile Items ;) Mobile/V2/Albums/Filter
            function loadItems() {
                ...
                apiService.post($scope.baseURL + 'api/Mobile/V2/Albums/Filter', filterDate,
                    itemsLoadCompleted,
                    itemsLoadFailed);
            }
            ...
            function ContentLoadCompleted(response) {
                console.log(response.data.Result, "Content loaded");
