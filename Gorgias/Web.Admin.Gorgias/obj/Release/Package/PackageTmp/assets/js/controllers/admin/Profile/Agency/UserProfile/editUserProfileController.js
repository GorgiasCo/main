(function (app) {
    'use strict';
    app.controller('editUserProfileController', ['$scope', '$route', '$http', 'apiService', 'ngAuthSettings', '$location', 'notificationService', function ($scope, $route, $http, apiService, ngAuthSettings, $location, notificationService) {

        var vm = this;
        $scope.object = {};
        
        console.log("editUserProfileController loaded ;)");
        ...
        //$scope.UserProfileID = $route.current.params.id;                        
        $scope.hasFile = false;
        ...
        function insertObject() {
            apiService.post($scope.baseURL +'api/UserProfile/ProfileID/UserRoleID/UserID/' + $scope.ProfileID + "/"  + $scope.UserRoleID + "/"  + $scope.UserID, $scope.object,
