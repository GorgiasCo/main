...
namespace Gorgias.DataLayer.Interface
{
    public interface IFBActivityRepository
    {
        ...
        FBActivity Insert(double FBActivityCount, DateTime FBActivityDate, int FBActivityType);
        bool Update(int FBActivityID, double FBActivityCount, DateTime FBActivityDate, int FBActivityType);
