...
namespace Gorgias.DataLayer.Repository.SQL
{
    public class ProfileReportRepository : IProfileReportRepository, IDisposable
    {
        ...
        //CRUD Functions
        public ProfileReport Insert(long ProfileReportActivityCount, double ProfileReportRevenue, int ReportTypeID, int ProfileID, int RevenueID)
        {
            try
            {
        ...
        public bool Update(int ProfileReportID, long ProfileReportActivityCount, double ProfileReportRevenue, int ReportTypeID, int ProfileID, int RevenueID)
        {
            ProfileReport obj = new ProfileReport();
