(function (app) {
    'use strict';
    app.controller('detailController', ['$scope', '$route', '$http', '$compile', 'apiService', 'DTOptionsBuilder', 'DTColumnBuilder', function ($scope, $route, $http, $compile, apiService, DTOptionsBuilder, DTColumnBuilder) {
