(function () {
    ...
    var app = angular
        .module('heroesApp', ['ngRoute', 'datatables', 'LocalStorageModule', 'angular-loading-bar'])
        .config(config);
    ...
    //heroesController.$inject = ['$scope', '$route', 'apiService'];

    //function heroesController($scope, $route, apiService) {
    //    $scope.Heroes = "SALAM";
    //    $scope.AddMovieModel = AddMovieModel;
    //    $scope.genre = { Name: "", ID: 0 };
    //    $scope.error = [];
    ...
    //    } else {
    //        apiService.getWithPromise('api/genres/GetValues/' + $route.current.params.id).then(
    //        function (result) {
    //            // promise was fullfilled (regardless of outcome)
    //            // checks for information will be peformed here
    //            $scope.account = result;
    ...
    //        }
    //    );
    //        console.log('Second ;)' + $route.current.params.id)
    //    }

    //    apiService.post('/api/genres/add', $scope.genre, addMovieSucceded, addMovieFailed);
    //    console.log("add triggered !!!");

    //    apiService.get('/api/genres/GetCountry/1/2', config, addMovieSucceded, addMovieFailed);
    //    console.log("add triggered !!!");

    //    apiService.get('/api/genres/GetCountry/tune/1/2', config, addMovieSucceded, addMovieFailed);
    //    console.log("add triggered !!!");

    //    apiService.get('/api/genres/GetValue', config, addMovieSucceded, addMovieFailed);
    //    console.log("add triggered !!!");


    //    function AddMovieModel() {
    //        apiService.post('/api/genres/add', $scope.genre,
    //        addMovieSucceded,
    //        addMovieFailed);
    //        console.log("add triggered !!!");
    //    }
    ...
    //        console.log("add triggered successfully");
    ...
    //detailController.$inject = ['$scope', '$route', '$http', '$compile', 'apiService', 'DTOptionsBuilder', 'DTColumnBuilder'];

    //function detailController($scope, $route, $http, $compile, apiService, DTOptionsBuilder, DTColumnBuilder) {
    //    var vm = this;
    //    $scope.Heroes = "SALAM";
    ...
    //        apiService.get('/api/cities/' + page + "/" + $scope.pagesize, null,
    //        addMovieSucceded,
    //        addMovieFailed);
