...
namespace Gorgias.Infrastruture.Core.Upload.Helper
{
    public static  class BlobHelper
    {
        ...
        public static CloudBlobContainer GetAlbumBlobContainer()
        {
            // Pull these from config
            var blobStorageConnectionString = ConfigurationManager.AppSettings["BlobStorageConnectionString"];
            var blobStorageContainerName = ConfigurationManager.AppSettings["BlobStorageAlbumsContainerName"];
