...
namespace Gorgias.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            var result = await _repo.Forget(username);
            //BusinessLayer.Facades.Facade.WebFacade().GenerateQRCode(2);
            return result;
        }
        ...
        {
            //var resultUser = await _repo.GetUser(userId);
            //var generateToken = await _repo.Forget(resultUser.UserName);
        ...
        {
            var result = await _repo.ChangePassword(changePasswordModel);
            return result;
        }
        ...
        {
            var result = await _repo.ResetPassword(resetPasswordModel);
            return result;
        }
        ...
        public async Task<IHttpActionResult> Register(UserModel userModel)
        {
            ...
            BusinessLayer.Facades.Facade.WebFacade().setupNewUserProfile(userModel.UserName, userModel.UserFullname, userModel.ProfileTypeID);

            return Ok();
        }

        [AllowAnonymous]
        [Route("Register/Mobile/V2")]
        [HttpPost]
